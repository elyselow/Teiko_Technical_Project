...
- Teiko_Technical_Assessment.py is the main Python analysis script for parts 2-4 of the project instructions in .py format
...
- Teiko_Technical_Interactive_Dashboard.py is the Python script for generation of the Streamlit interactive dashboard in .py format 
